...
export const seedDatabase = async () => {
  try {
    ...
    const createdCategories = await PhotoshootCategory.insertMany(categoriesData);
    ...
    const job1 = await PhotoJob.create({
      jobId: 'MEM-JOB-7701',
    ...
    const job2 = await PhotoJob.create({
      jobId: 'MEM-JOB-7702',
    ...
    const job3 = await PhotoJob.create({
      jobId: 'MEM-JOB-7703',
    ...
    const job4 = await PhotoJob.create({
      jobId: 'MEM-JOB-7704',
