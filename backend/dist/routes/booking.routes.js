...
router.get('/my', auth_js_1.authenticateJWT, booking_controller_js_1.getMyBookings);
...
router.get('/studio/:studioId', auth_js_1.authenticateJWT, (0, roles_js_1.authorizeRoles)('shop_owner', 'admin'), booking_controller_js_1.getStudioBookings);
